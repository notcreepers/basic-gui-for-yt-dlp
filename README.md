...
## Installation
Literally just [download](https://www.github.com/notcreepers/basic-gui-for-yt-dlp/releases) the exe and run it. If you don't feel comfortable doing that, check my code and build it yourself. I used pyinstaller so it's gonna get picked up as a trojan by a few AVs. If you're using Avast, that's your fault.
